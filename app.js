// Configuração do Supabase - SUBSTITUA PELAS SUAS CREDENCIAIS DO PROJETO SUPABASE
        ...
        function renderDashboard() {
            ...
            const stats = [
                ...
                { label: 'Estoque Baixo', value: state.dashboardStats.lowStock, color: 'bg-yellow-500', icon: '<svg class="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M8.257 3.324a1 1 0 01.993-.057l7.5 4.5a1 1 0 010 1.63L9.257 16.73a1 1 0 01-1.026-.048L.775 9.072a1 1 0 010-1.63l7.5-4.5z" clip-rule="evenodd"></path></svg>' },
                { label: 'Itens Críticos', value: state.dashboardStats.criticalItems, color: 'bg-red-500', icon: '<svg class="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zM8.707 7.293a1 1 0 00-1.414 1.414L8.586 10l-1.293 1.293a1 1 0 101.414 1.414L10 11.414l1.293 1.293a1 1 0 001.414-1.414L11.414 10l1.293-1.293a1 1 0 00-1.414-1.414L10 8.586 8.707 7.293z" clip-rule="evenodd"></path></svg>' },
                { label: 'Consumo Mensal', value: state.dashboardStats.monthlyConsumption, color: 'bg-green-500', icon: '<svg class="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M3 3a1 1 0 000 2h11.586l-4.293 4.293a1 1 0 000 1.414l3 3a1 1 0 001.414-1.414L10.414 10l4.293-4.293A1 1 0 0014 4H3z" clip-rule="evenodd"></path></svg>' }
            ];
